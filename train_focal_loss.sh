...
nohup python -u ./src/trainer_focal_loss.py --datasetPath ./data/BGC_train_dataset_plus.csv \
    ...
    >./nohup/transformerEncoder_BGC_focal_loss_$max_len$nhead$seed$num_encoder_layers$transformer_dropout$mlp_dropout$batch_size$learning_rate$distribute_epochs$warmup_epochs$alpha$gamma.out &